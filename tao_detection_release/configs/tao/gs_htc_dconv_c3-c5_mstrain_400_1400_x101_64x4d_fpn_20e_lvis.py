...
model = dict(
    ...
    bbox_head=[
        dict(
            ...
            gs_config=dict(
                label2binlabel='./data/lvis_v0.5/annotations/label2binlabel.pt',
                pred_slice='./data/lvis_v0.5/annotations/pred_slice_with0.pt',
                fg_split='./data/lvis_v0.5/annotations/valsplit.pkl',
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/train_amend_lvis.json',
